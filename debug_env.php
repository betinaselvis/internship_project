...
echo "<h2>Raw Environment Variables</h2>";
echo "<pre>";
...
echo "<h2>Parsed Constants</h2>";
echo "<pre>";
echo "DB_HOST: " . htmlspecialchars(DB_HOST) . "\n";
echo "DB_PORT: " . htmlspecialchars((string)DB_PORT) . "\n";
...
try {
    ...
    echo "<ul>";
    echo "<li>Check MYSQL_URL is set in Railway environment</li>";
    echo "<li>Or check individual MYSQL_* variables are set correctly</li>";
